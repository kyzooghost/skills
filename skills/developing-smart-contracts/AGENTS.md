# Smart Contracts - Development Guidelines
...
> generating, or refactoring Solidity smart contracts. Humans  
...
Comprehensive development guidelines for smart contracts, designed for AI agents and LLMs. Contains rules across 6 categories, prioritized by impact from critical (NatSpec documentation) to incremental (general rules). Each rule includes detailed explanations, real-world examples comparing incorrect vs. correct implementations.

Reference: [Contract Style Guide](contracts/docs/contract-style-guide.md)
