...
- [ ] **Step 4: Re-run the focused test and verify the next RED failure**
...
- [ ] **Step 1: Add failing tests for dry-run and fail-fast behavior**
...
- [ ] **Step 3: Implement the `gh api` boundary**
...
- [ ] **Step 3: Implement CLI parsing and skill integration**
...
- [ ] **Step 4: Run the CLI and full unit suite**
...
- [ ] **Step 5: Commit the CLI and skill documentation**
